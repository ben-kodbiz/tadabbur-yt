...
from tadabbur.validator import run_validation as engine_run_validation


def run_validation(settings: Settings, *, video_id: str | None = None) -> str:
    ...
    try:
        ...
        return engine_run_validation(settings, repo, video_id=video_id)
    finally:
        conn.close()
